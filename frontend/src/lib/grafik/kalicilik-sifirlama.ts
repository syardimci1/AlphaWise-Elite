...
/**
 * Kullanicinin BU sembol icin kayitli gosterge ve cizimlerini siler.
 *
...
export function kayitlariSifirla(
  ...
  const hatalar = [sil(depo, kullaniciKimligi, sembol), gostergeleriSil(depo, kullaniciKimligi, sembol)]
