...
import type { SinyalDurumu } from '../../../components/DashboardBilesenleri'
...
export default function Dashboard() {
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 'clamp(12px, 4vw, 32px)' }}>
      <UstBar userEmail={userEmail} onCikis={handleLogout} />
      ...
      <AramaFormu ticker={ticker} setTicker={setTicker} loading={loading} onGonder={handleSearch} />
